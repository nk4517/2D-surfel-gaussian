...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, alpha, normal, radii, geomBuffer, binningBuffer, imgBuffer, ray_P, ray_M = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, alpha, normal, ray_P, ray_M

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_alpha, grad_normal, grad_P, grad_M):
